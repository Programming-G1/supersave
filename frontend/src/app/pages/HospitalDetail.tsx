...
export default function HospitalDetail() {
  ...
  const { hospitals, congestionData, loading, error } = useEmergencyAppData();
  ...
  const totalBeds =
    ...
    hospital.beds.icu +
    hospital.beds.surgery;
  const estimatedWait =
    hospital.currentWaitTime + hospital.arrivingPatients * 5;
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <Badge
            className={`text-lg px-4 py-2 ${getCongestionColor(hospital.congestionLevel)}`}
          >
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(hospital.beds.general / 20) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(hospital.beds.icu / 10) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${(hospital.beds.surgery / 10) * 100}%`,
                  }}
                />
              </div>
            </div>
